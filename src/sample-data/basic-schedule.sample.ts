  ...
  workOrders: [
    {
      ...
      data: {
        ...
        endDate: "2026-01-06T15:00:00.000Z",
        durationMinutes: 180,
        isMaintenance: false,
    ...
    },
    {
      ...
      data: {
        ...
        workCenterId: "wc-extrusion-b",
        startDate: "2026-01-01T07:00:00.000Z",
        endDate: "2026-01-07T15:00:00.000Z",
        durationMinutes: 60,
        isMaintenance: true,
    ...
    },
    {
      ...
      data: {
        ...
        endDate: "2026-01-10T17:00:00.000Z",
        durationMinutes: 240,
        isMaintenance: false,
    ...
    {
      docId: "wo-yellow-line-check",
      docType: "workOrder",
      data: {
        workOrderNumber: "WO-1003-MNT",
        manufacturingOrderId: "mo-yellow-pipe",
    ...
    },
    {
      ...
      data: {
        ...
        workCenterId: "wc-packaging",
        startDate: "2026-01-02T10:00:00.000Z",
        endDate: "2026-01-12T18:00:00.000Z",
        durationMinutes: 120,
        isMaintenance: false,
    ...
    },
    {
      ...
      data: {
        ...
        workCenterId: "wc-cutting",
        startDate: "2026-01-01T09:00:00.000Z",
        endDate: "2026-01-13T17:00:00.000Z",
        durationMinutes: 180,
        isMaintenance: false,
    ...
    },
    {
      ...
      data: {
        ...
        workCenterId: "wc-packaging",
        startDate: "2026-01-02T10:00:00.000Z",
        endDate: "2026-01-14T18:00:00.000Z",
        durationMinutes: 45,
        isMaintenance: true,
    ...
    },
    {
      ...
      data: {
        ...
        durationMinutes: 120,
        isMaintenance: false,
        dependsOnWorkOrderIds: ["wo-blue-pack-setup"],
      },
    },
    {
      ...
      data: {
        ...
        workCenterId: "wc-packaging",
        startDate: "2026-01-02T10:00:00.000Z",
        endDate: "2026-01-16T18:00:00.000Z",
        durationMinutes: 180,
        isMaintenance: false,
        dependsOnWorkOrderIds: ["wo-yellow-line-check"],
      },
    },
  ],
...
export const basicScheduleScenarioNotes = [
  ...
  "Work order start and end dates are wide placement windows, so the scheduler chooses the earliest available time inside each window.",
